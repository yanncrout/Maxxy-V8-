<p align="center">
    <img src="https://telegra.ph/file/164709f787e0305472579.jpg" width="100%" style="margin-left: auto;margin-right: auto;display: block;">
</p>
<h1 align="center">𝙈𝙖𝙭𝙭𝙮-𝙓𝘿</h1>
...
## ```Heroku Buildpack```
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Maxxy-Md/Maxxy-V8)
...
$ git clone https://github.com/Maxxy-Md/V8
$ cd Maxxy-V8
$ npm i 
```
...
git clone https://github.com/Maxxy-Md/Maxxy-V8
cd Maxxy-V8
npm install
npm update
```
...
```bash
git https://github.com/Maxxy-Md/Maxxy-V8
cd Maxxy-V8
npm install
npm update
```
